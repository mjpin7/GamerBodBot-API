...
class Backlog(Resource):
    ...
    def get(self, user_id):
        ...
        if item:
            ...
            resp = requests.get("https://api-v3.igdb.com/search/", data={bytes('search \"{}\"; fields name,game.url,game.summary,game.rating;'.format(json['game']), 'utf-8')}, headers={"user-key": os.environ.get('GAME_API_KEY')})
